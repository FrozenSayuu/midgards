...
if (!function_exists('halsocentertheme_setup')) :
    /**
     ...
     */
    function halsocentertheme_setup()
    {
    ...
    add_action('after_setup_theme', 'halsocentertheme_setup');
    ...
    // Adding a custom post type called behandlingar
    function behandlingar()
    {
        register_post_type('behandling', [
            'labels' => [
                'name'     => 'Behandlingar',
                'singular' => 'Behandling',
            ],
            'public'     => true,
            'rewrite'    => ['slug' => 'behandling'],
            'menu_icon' => 'dashicons-book-alt',
            'supports'   => ['title', 'editor', 'thumbnail']
        ]);
    }
    add_action('init', 'behandlingar', 5);
